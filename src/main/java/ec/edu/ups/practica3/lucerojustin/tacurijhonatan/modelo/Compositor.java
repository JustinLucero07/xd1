 ...
 */
package ec.edu.ups.practica3.lucerojustin.tacurijhonatan.modelo;
...
public class Compositor extends Persona {
    ...
    public void agregarCancion(List<Cancion> listcan){ // Método para agregar una canción al top 100 de Billboard
        // Se crea un objeto de tipo Cancion
        cancionesTop100Billboard = listcan; // Se agrega la canción a la lista de canciones top 100 de Billboard
    }
    
    
    
    public void agregarClientE(List<Cantante> clientes) { // Método para agregar un cantante cliente al compositor
        cliente = clientes; // Se agrega el cantante a la lista de clientes del compositor
    }
